            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  ...
                  <a class="nav-link" href="index">Home <span class="sr-only">(current)</span>
              <br>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
              Where Protection Meets Professionalism."<br>
"Defending You with Integrity."
                    </p>
                    <div class="btn-box">
                      <a href="register" class="btn-1"> Register</a>
                  
             
                      <a href="login" class="btn-2">Login</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
          Welcome to The Guarder, where your safety is our top priority. Our team of highly trained security guards is dedicated to providing professional, reliable protection tailored to your needs. With expertise in access control, surveillance, and emergency response, we ensure peace of mind for businesses and individuals alike. Trust us to guard what matters most to you!
            </p>
            <div class="btn-box">
              <a href="">
                Read More
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                At Guarder, we understand that your home is your sanctuary. Our trained security guards provide round-the-clock protection, ensuring peace of mind for you and your family. With tailored solutions, from surveillance to access control, we prioritize your safety. Trust us to guard your home with professionalism and care, so you can truly relax.
              </p>
              <a href="">
                Read More
              </a>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
              Guarder Services delivers comprehensive office security solutions designed to safeguard your workplace and enhance safety. Our trained professionals implement proactive measures to deter threats, ensuring a secure environment for your team. With advanced monitoring and rapid response protocols, we prioritize the protection of your assets and personnel. Trust Guarder Services to create a resilient security framework that fosters productivity and peace of mind in your office.
              </p>
              <a href="">
                Read More
              </a>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Guarder Services offers elite personal bodyguard solutions, ensuring your safety with unmatched vigilance and professionalism. Our trained experts navigate high-pressure situations, providing a secure environment tailored to your needs. With a focus on discreet yet effective protection, we prioritize your peace of mind. Trust Guarder Services to empower your life with the confidence that comes from having a dedicated protector by your side.
              </p>
              <a href="">
                Read More
              </a>
          ...
          <div class="carousel-item active">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                 I couldnt be happier with the security service from Guarder. Their guards are professional, attentive, and made us feel safe at our event!
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
              Guarder provided exceptional security for our business. Their trained personnel handled everything flawlessly, allowing us to focus on our work without worry.
                </p>
              </div>
            </div>
          </div>
            ...
            <form action="send" method="post">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                 <input type="text" name="ccity" required placeholder="Your city name" />

                  </div>
                  <div class="">
                    <input type="text" placeholder="Message" name="cmsg" class="message_input" />
                  </div>
                  <div class="btn-box ">
                    <button type="submit">
                      Send
  ...
  <section class="team_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
         "Guarder Services: Vigilant warriors dedicated to your safety and peace of mind."
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            ...
            <p>
              "Guarder Services: Where Warriors of Safety Stand Vigilant."
            </p>
          </div>
        </div>
        <div class="col-md-3">
